...
//parseInt의 겨우 값의 맨앞이 숫자일 경우에만 인식하고, 숫자이면 숫자가 있는 곳까지를 숫자로 인식한다.
console.log(삼백 + 100);
...
var 숫자삼백숫자=숫자삼백+'';
console.log(숫자삼백숫자);
console.log(typeof 숫자삼백숫자)

//숫자와 문자를 함께 사용할 때 괄호로 조정할 수 있다.
console.log('age :'+ 10+2);   // 'age :102'
console.log('age :'+ (10+2)); // 'age : 12'
...
console.log(su1);
// NaN이라고 출력한다. 숫자가 아니라고 말해주는 거임.
/////////////////////////////////

console.log(isNaN(su1));//su1이 NaN인지 아닌지를 뭇는 내용.

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// typeof 연산자는 해당 변수에 저장된 값이 어떤 타입인지를 알려준다.
console.log(typeof 삼백); //'string'
console.log(typeof 100); //'number'
console.log(typeof false); //'boolean'

var 언디파인드;
console.log(typeof 언디파인드); //"undefine"
